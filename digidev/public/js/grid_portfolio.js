...
function relocate() {
	...
	if ($(window).width() > 350) itemInRow = 2;
	if ($(window).width() > 525) itemInRow = 3;
	if ($(window).width() > 700) itemInRow = 4;
	if ($(window).width() > 875) itemInRow = 5;
	if ($(window).width() > 1050) itemInRow = 6;
	if ($(window).width() > 1225) itemInRow = 7;
	if ($(window).width() > 1400) itemInRow = 8;
